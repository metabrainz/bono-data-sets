...
class BulkRecordingLookupQuery(Query):
    '''
        Look up a tag and popularity data for a list of recordings, based on MBID. 
    '''

    def names(self):
        return ("bulk-recording-lookup", "Bulk MusicBrainz Tag/Popularity by recording MBID Lookup")
    ...
    def fetch(self, params, offset=-1, count=-1):
        ...
        with psycopg2.connect(config.DB_CONNECT_GAGA) as conn:
